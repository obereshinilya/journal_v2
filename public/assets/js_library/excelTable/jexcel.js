...
;(function (global, factory) {
    ...
    var jexcel = (function(el, options) {
        ...
        var defaults = {
            ...
            // Texts
            text:{
                noRecordsFound: 'Ничего не найдено...',
                showingPage: 'Страница {0} из {1}',
                show: 'Показать ',
                search: 'Поиск',
                entries: ' entries',
                columnName: 'Наименование столбца',
                insertANewColumnBefore: 'Вставить столбец до',
                insertANewColumnAfter: 'Вставить столбец до',
                deleteSelectedColumns: 'Удалить выбранные столбцы',
                renameThisColumn: 'Переименовать столбец',
                orderAscending: 'По возрастанию',
                orderDescending: 'По убыванию',
                insertANewRowBefore: 'Вставить строку до',
                insertANewRowAfter: 'Вставить строку после',
                deleteSelectedRows: 'Удалить выбранные строки',
                editComments: 'Изменить комментарий',
                addComments: 'Добавить комментарий',
                comments: 'Комментарии',
                clearComments: 'Очистить комментарий',
                copy: 'Копировать...',
                paste: 'Вставить...',
                saveAs: 'Сохранить...',
                about: 'About',
        ...
        obj.openFilter = function(columnId) {
            if (! obj.options.filters) {
                ...
                if (obj.options.columns[columnId].type == 'checkbox') {
                    ...
                    // Has blank options
                    if (hasBlanks) {
                        optionsFiltered.push({ value: '', id: '', name: '(Пусто)' });
                    }
                }
