...
@section('content')
    <div id="header_block_param" style="overflow-x: auto; overflow-y: hidden; max-height: 3.5em">
        <p id="header_doc" style="display: inline-block; max-width: 50%">Опробование алгоритмов/проведение регламентных работ</p>
            ...
            $.ajax({
                ...
                success: function(res) {
                    jsTable = jspreadsheet(document.getElementById('main_div'), {
                        ...
                        csvFileName: 'Опробование алгоритмов/проведение регламентных работ'
                    });
