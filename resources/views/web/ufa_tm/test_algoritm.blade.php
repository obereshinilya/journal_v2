...
@section('content')
    <div id="header_block_param" style="overflow-x: auto; overflow-y: hidden; max-height: 3.5em">
        <p id="header_doc" style="display: inline-block; max-width: 50%">Опробование алгоритнов/проведение регламентных работ</p>
            ...
            $.ajax({
                ...
                success: function(res) {
                    jsTable = jspreadsheet(document.getElementById('main_div'), {
                        ...
                        columns: [
                            {type:'hidden',name:'id'},
                            {width:width,type:'text',name:'comment',title:'Описание события',readOnly:true,},
                        ...
                        csvFileName: 'Опробование алгоритнов/проведение регламентных работ'
                    });
                    ...
                    $('#main_content table tr').on('dblclick', function (){
                        window.location.href = '/open_record_ufa_tm/'+this.getElementsByTagName('td')[1].textContent
                    })
